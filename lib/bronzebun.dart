...
class BronzePage extends StatefulWidget {
  final Function(Map<String, String>) onAddToCart;

  BronzePage({required this.onAddToCart});

  @override
  _BronzePageState createState() => _BronzePageState();
}

class _BronzePageState extends State<BronzePage> {
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('img/bronze.png', fit: BoxFit.cover),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4), // Jarak antara dua teks
                          Text(
                            "Nails and Make Up",
                            style: const TextStyle(
                              fontSize: 18, // Ukuran font untuk teks tambahan
                              color: Colors.pinkAccent, // Warna teks tambahan
                            ),
                          ),
                        ],
                      ),
                    ...
                    onPressed: () async {
                      ...
                      if (isAvailable) {
                        Map<String, String> serviceDetails = {
                          'service': 'Bronze Bundle',
                          'time': selectedDateTime,
                          'price': '450000'
                        };
                        widget.onAddToCart(serviceDetails);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Bronze Bundle added to cart for $selectedDateTime')),
                        );
                      } else {
                        showDialog(
                          context: context,
