...
class PremiumPage extends StatefulWidget {
  ...
  PremiumPage({required this.onAddToCart});
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('img/gold.png', fit: BoxFit.cover),
                      ),
                    ),
                    ...
                    onPressed: () async {
                      ...
                      if (isAvailable) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Premium Bundle added to cart for $selectedDateTime')),
                        );
                      } else {
                        showDialog(
                          context: context,
