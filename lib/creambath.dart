...
class CreambathPage extends StatefulWidget {
  final Function(Map<String, String>) onAddToCart;

  CreambathPage({required this.onAddToCart});

  @override
  _CreambathPageState createState() => _CreambathPageState();
}

class _CreambathPageState extends State<CreambathPage> {
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('img/creambath0.jpg', fit: BoxFit.cover),
                      ),
                    ),
                    ...
                    onPressed: () async {
                      ...
                      if (isAvailable) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Creambath added to cart for $selectedDateTime')),
                        );
                      } else {
                        showDialog(
                          context: context,
