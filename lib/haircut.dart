...
class HaircutPage extends StatefulWidget {
  ...
  HaircutPage({required this.onAddToCart});

  @override
  _HaircutPageState createState() => _HaircutPageState();
}
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('img/haircut0.jpg', fit: BoxFit.cover),
                      ),
                    ),
                    ...
                    onPressed: () async {
                      ...
                      if (isAvailable) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Hair Cut added to cart for $selectedDateTime')),
                        );
                      } else {
                        showDialog(
                          context: context,
