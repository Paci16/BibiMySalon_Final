...
class DiamondPage extends StatefulWidget {
  ...
  DiamondPage({required this.onAddToCart});
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('img/silver.png', fit: BoxFit.cover),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Creambath, Haircut, and Coloring",
                            style: const TextStyle(
                ...
                GridView.count(
                  ...
                  children: ['img/creambath1.jpg', 'img/haircut (2).jpg', 'img/coloring3.jpg', 'img/coloring0.jpg']
                      .map((image) => Container(
                    ...
                    onPressed: () async {
                      ...
                      if (isAvailable) {
                        Map<String, String> serviceDetails = {
                          'service': 'Diamond Bundle',
                          'time': selectedDateTime,
                          'price': '450000'
                        };
                        widget.onAddToCart(serviceDetails);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Diamond Bundle added to cart for $selectedDateTime')),
                        );
                      } else {
                        showDialog(
                          context: context,
