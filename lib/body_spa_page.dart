...
class BodySpaPage extends StatefulWidget {
  final Function(Map<String, String>) onAddToCart;

  BodySpaPage({required this.onAddToCart});

  @override
  _BodySpaPageState createState() => _BodySpaPageState();
}

class _BodySpaPageState extends State<BodySpaPage> {
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('img/spa0.jpg', fit: BoxFit.cover),
                      ),
                    ),
                    ...
                    onPressed: () async {
                      ...
                      if (isAvailable) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Body Spa added to cart for $selectedDateTime')),
                        );
                      } else {
                        showDialog(
                          context: context,
