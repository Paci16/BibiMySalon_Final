            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset('img/nailart0.jpg', fit: BoxFit.cover),
                      ),
                    ),
                ...
                GridView.count(
                  ...
                  children: ['img/nailart1.png', 'img/nailart2.png', 'img/nailart3.png', 'img/nailart4.png']
                      .map((image) => Container(
                    ...
                    onPressed: () async {
                      ...
                      if (isAvailable) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Nail Art added to cart for $selectedDateTime')),
                        );
                      } else {
                        showDialog(
                          context: context,
